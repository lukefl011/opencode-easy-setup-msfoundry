---
description: Use to persist execution-ready plans into markdown state files that track task progress for build delivery
mode: subagent
...
- Return the exact path to the state file so `build` can use it as execution monitor.
